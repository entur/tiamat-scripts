...
#echo NRI
#curl -H "Content-Type: application/xml" -XPOST -d@NRI_Netex.xml_Enriched.xml "http://localhost:1997/services/stop_places/netex?importType=MATCH&skipOutput=true"
